...
export default function LoginPage() {
    ...
    async function onLogin() {
        ...
        } catch (signInIssue: any) {
            setError(signInIssue.message ?? "Unable to sign in. Please check your credentials and try again.");
        } finally {
            setLoading(false);
        }
    }
            ...
            <div className="container mx-auto px-4 max-w-md">
                ...
                <div className="space-y-5 bg-white p-8 md:p-10 rounded-2xl shadow-2xl border border-gray-100">
                    ...
                    <div className="flex flex-col gap-4 pt-2">
                        <button
                            type="button"
                            className="w-full flex items-center justify-center gap-3 py-3 px-6 border-2 border-gray-200 rounded-xl font-semibold text-gray-700 bg-white hover:bg-gray-50 transition"
                        >
