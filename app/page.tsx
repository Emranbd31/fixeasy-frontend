...
const services = [
  { id: 1, name: 'Cleaning', description: 'Professional home & office cleaning', gradient: 'from-blue-400 to-cyan-400', price: '€29', image: '/images/Cleaning.png' },
  { id: 2, name: 'Handyman', description: 'Expert repair & maintenance', gradient: 'from-orange-400 to-red-400', price: '€35', image: '/images/Handyman.png' },
  { id: 3, name: 'Plumbing', description: 'Licensed plumbing services', gradient: 'from-blue-500 to-indigo-500', price: '€45', image: '/images/services/plumbing.png' },
  { id: 4, name: 'Electrical', description: 'Certified electrical work', gradient: 'from-yellow-400 to-orange-500', price: '€55', image: '/images/Electrical.png' },
  { id: 5, name: 'Painting', description: 'Interior & exterior painting', gradient: 'from-purple-400 to-pink-500', price: '€40', image: '/images/Painting.png' },
  { id: 6, name: 'Gardening', description: 'Lawn care & landscaping', gradient: 'from-green-400 to-emerald-500', price: '€30', image: '/images/Gardening.png' },
  { id: 7, name: 'Moving', description: 'Reliable moving services', gradient: 'from-indigo-400 to-blue-500', price: '€60', image: '/images/Moving.png' },
  { id: 8, name: 'Carpentry', description: 'Custom woodwork & furniture', gradient: 'from-amber-600 to-orange-600', price: '€50', image: '/images/Carpentry.png' },
  { id: 9, name: 'Appliance Repair', description: 'Fix all home appliances', gradient: 'from-gray-500 to-slate-600', price: '€40', image: '/images/Appliance Repair.png' },
  { id: 10, name: 'HVAC', description: 'Heating & cooling services', gradient: 'from-cyan-500 to-blue-600', price: '€65', image: '/images/HVAC.png' },
  ...
  { id: 12, name: 'Locksmith', description: 'Security & lock services', gradient: 'from-slate-600 to-gray-700', price: '€35', image: '/images/Locksmith.png' },
  { id: 13, name: 'Welding', description: 'Metal fabrication & welding', gradient: 'from-orange-600 to-red-600', price: '€70', image: '/images/Welding.png' },
  { id: 14, name: 'CCTV Installation', description: 'Security camera systems', gradient: 'from-slate-700 to-gray-800', price: '€80', image: '/images/CCTV Installation.png' },
  { id: 15, name: 'Solar Panels', description: 'Solar energy installation', gradient: 'from-yellow-500 to-orange-600', price: '€150', image: '/images/Solar Panels.png' },
  { id: 16, name: 'Builder', description: 'Construction & renovation', gradient: 'from-orange-500 to-amber-600', price: '€85', image: '/images/Builder.png' },
  { id: 17, name: 'Roofing', description: 'Roof repair & installation', gradient: 'from-gray-600 to-slate-700', price: '€75', image: '/images/Roofing.png' },
  { id: 18, name: 'Flooring', description: 'Floor installation & repair', gradient: 'from-amber-700 to-orange-800', price: '€55', image: '/images/Flooring.png' },
  { id: 19, name: 'Tiling', description: 'Professional tiling services', gradient: 'from-teal-500 to-cyan-600', price: '€50', image: '/images/Tiling.png' },
  { id: 20, name: 'Plastering', description: 'Wall plastering & finishing', gradient: 'from-gray-400 to-gray-600', price: '€45', image: '/images/Plastering.png' },
  { id: 21, name: 'Window Cleaning', description: 'Exterior & interior windows', gradient: 'from-sky-400 to-blue-500', price: '€35', image: '/images/Window Cleaning.png' },
  { id: 22, name: 'Pressure Washing', description: 'Deep cleaning driveways', gradient: 'from-blue-600 to-cyan-700', price: '€40', image: '/images/Pressure Washing.png' },
  { id: 23, name: 'Chimney Sweep', description: 'Chimney cleaning & inspection', gradient: 'from-stone-600 to-gray-700', price: '€60', image: '/images/Chimney Sweep.png' },
  { id: 24, name: 'Gutter Cleaning', description: 'Gutter maintenance & repair', gradient: 'from-blue-500 to-slate-600', price: '€40', image: '/images/Gutter Cleaning.png' },
  { id: 25, name: 'Air Conditioning', description: 'AC installation & repair', gradient: 'from-cyan-600 to-blue-700', price: '€70', image: '/images/Air Conditioning.png' },
  { id: 26, name: 'Roof Cleaning', description: 'Roof moss removal & cleaning', gradient: 'from-green-600 to-teal-700', price: '€65', image: '/images/Roof Cleaning.png' },
  { id: 27, name: 'Carpet Cleaning', description: 'Deep carpet cleaning service', gradient: 'from-indigo-500 to-purple-600', price: '€50', image: '/images/Carpet Cleaning.png' },
];
